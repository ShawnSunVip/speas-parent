...
import com.sun.speas.exception.BusinessException;
...
public class DateUtils {
    ...
    public static String formatDate(String dateStr, String originalFormat, String nowFormat) {
        try {
            ...
            throw new BusinessException(HttpStatus.DATE_PARSE_EXCEPTION.getCode(), HttpStatus.DATE_PARSE_EXCEPTION.getMessage() + e);
        }
    }
